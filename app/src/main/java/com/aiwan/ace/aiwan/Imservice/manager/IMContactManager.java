...
import com.aiwan.ace.aiwan.Imservice.event.UserInfoEvent;
...
public class IMContactManager extends IMManager {
    ...
    public void onLocalNetOk(){
        ...
        logger.d(Tag, "contact#loadAllUserInfo req-updateTime:%d", updateTime);
	...
	public void onRepAllUsers(IMBuddy.IMAllUserRsp imAllUserRsp) {
		...
		logger.i(Tag, "contact#user cnt:%d", count);
        if(count <=0){
            return;
        }
