package com.aiwan.ace.aiwan.Imservice.network;
...
public class MsgServerHandler extends SimpleChannelHandler {
    private static final String Tag = "MsgServerHandler";
    ...
    public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e)
        ...
        logger.d(Tag, "channel#channelConnected");
    ...
    public void channelDisconnected(ChannelHandlerContext ctx,
         ...
         *
         **/
        logger.d(Tag, "channel#channelDisconnected");
    ...
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e)
        ...
        logger.d(Tag, "channel#messageReceived");
        // 重置AlarmManager的时间
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, ExceptionEvent e) throws Exception {
        ...
        logger.e(Tag, "channel#[网络异常了]exceptionCaught:%s", e.getCause().toString());
    }
}
