package com.aiwan.ace.aiwan.Protobuf.helper;
...
import com.aiwan.ace.aiwan.Imservice.entity.MsgAnalyzeEngine;
...
import com.aiwan.ace.aiwan.Utils.CommonUtil;
...
public class ProtoBuf2JavaBean {
    ...
    public static SessionEntity getSessionEntity(IMBaseDefine.ContactSessionInfo sessionInfo){
        ...
        //String desMessage = new String(com.aiwan.ace.aiwan.Utils.Security.getInstance().DecryptMsg(content));
        // 判断具体的类型是什么
