...
public class MixMessage extends MessageEntity {
    ...
    public MixMessage(List<MessageEntity> entityList){
        ...
        setId(justOne.getId());
        setMsgId(justOne.getMsgId());
        setFromId(justOne.getFromId());
        setToId(justOne.getToId());
        setSessionKey(justOne.getSessionKey());
        setMsgId(justOne.getMsgType());
        setStatus(justOne.getStatus());
        setCreated(justOne.getCreated());
        setUpdated(justOne.getUpdated());
        msgList = entityList;
        setDisplayType(DBConstant.SHOW_MIX_TEXT);
    ...
    public MixMessage(MessageEntity dbEntity){
        ...
        setMsgId(dbEntity.getMsgId());
        setFromId(dbEntity.getFromId());
        setToId(dbEntity.getToId());
        setMsgId(dbEntity.getMsgType());
        setStatus(dbEntity.getStatus());
        setCreated(dbEntity.getCreated());
        setUpdated(dbEntity.getUpdated());
        setContent(dbEntity.getContent());
        setDisplayType(dbEntity.getDisplayType());
        setSessionKey(dbEntity.getSessionKey());
