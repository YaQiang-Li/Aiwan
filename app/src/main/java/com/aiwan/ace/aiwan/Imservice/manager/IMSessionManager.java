...
import com.aiwan.ace.aiwan.Imservice.entity.RecentInfo;
...
import com.aiwan.ace.aiwan.Protobuf.IMBuddy;
...
public class IMSessionManager extends IMManager {
    private static final String Tag = "IMSessionManager";
    ...
    public void onNormalLoginOk() {
        logger.d(Tag, "recent#onLogin Successful");
        onLocalLoginOk();
        onLocalNetOk();
    }

    public void onLocalLoginOk(){
        logger.i(Tag, "session#loadFromDb");
    ...
    public void onLocalNetOk(){
        ...
        logger.d(Tag, "session#更新时间:%d",latestUpdateTime);
    ...
    private void reqGetRecentContacts(int latestUpdateTime) {
        logger.i(Tag, "session#reqGetRecentContacts");
    ...
    public void onRepRecentContacts(IMBuddy.IMRecentContactSessionRsp recentContactSessionRsp) {
        logger.i(Tag, "session#onRepRecentContacts");
        ...
        logger.i(Tag, "contact#user:%d  cnt:%d",userId,contactSessionInfoList.size());
        /**更新最近联系人列表*/
        ...
        logger.d(Tag, "session#onRepRecentContacts is ready,now broadcast");
    ...
    public  void reqRemoveSession(RecentInfo recentInfo) {
        logger.i(Tag, "session#reqRemoveSession");
    ...
    public void onRepRemoveSession(IMBuddy.IMRemoveSessionRsp removeSessionRsp) {
        logger.i(Tag, "session#onRepRemoveSession");
        int resultCode = removeSessionRsp.getResultCode();
        if(0 != resultCode){
            logger.e(Tag, "session#removeSession failed");
            return;
        }
    }
    ...
    public void updateSession(GroupEntity entity){
        logger.d(Tag, "recent#updateSession GroupEntity:%s", entity);
    ...
    public void updateSession(MessageEntity msg) {
        logger.d(Tag, "recent#updateSession msg:%s", msg);
        if (msg == null) {
            logger.d(Tag, "recent#updateSession is end,cause by msg is null");
            return;
        }
        int loginId =imLoginManager.getLoginId();
        ...
        if (sessionEntity == null) {
            logger.d(Tag, "session#updateSession#not found msgSessionEntity");
            ...
            logger.d(Tag, "session#updateSession#msgSessionEntity already in Map");
